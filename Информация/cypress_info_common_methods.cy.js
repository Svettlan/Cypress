...
// . click()     - клик -  check() / .uncheck - проверить/снять отметку - Этот элемент должен быть <input> с флажком типа или переключателем- чекбокс или инпут

// .dblclick()  - .select() Этот элемент должен иметь тег select
//  .rightclick  - .правый клик() - .trigger()
//  .type()  - тип()
// .clear() - 
